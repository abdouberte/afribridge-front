...
export const metadata: Metadata = {
  ...
  description: `Commande sur Amazon, AliExpress, Zara et plus — livré en Côte d'Ivoire et au Mali via Mobile Money. Sans carte bancaire.`,
  keywords: [
    "AfriBridge",
    "livraison Abidjan",
    "livraison Bamako",
